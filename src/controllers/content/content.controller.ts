...
import { IContentService } from 'src/services/content/IContentService'; // <-- 5. DÙNG TOKEN
import { ContentDto } from 'src/models/viewmodel/content/ContentDto';
...
export class ContentController {
  ...
  async get(@Query() serachPara: SerachPara) {
    ...
    return this.contentService.finds(serachPara);
  }
  ...
  async update(
    ...
    @Body() updateDto: ContentDto, // <-- Dùng DTO
  ) {
